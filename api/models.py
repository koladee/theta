...
class Profile(models.Model):
    ...
    hidden_toggle = models.BooleanField(default=True)
    public_toggle = models.BooleanField(default=True)
    mod_permission = models.BooleanField(default=False)
    bot_pause = models.BooleanField(default=False)
...
class List(models.Model):
    ...
    def __str__(self):
        return self.key+' <'+self.user.user.username+' minute(s)>'
